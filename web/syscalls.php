...
<table>
<tr><td>
List of System Calls. Each line is a link to correspoding system code.
<pre>
<a href="#syscall_ide">IDE services</a>
<a href="#syscall_io">I/O services</a>
<a href="#syscall_fs">Filesystem services</a>
<a href="#syscall_spawn">Spawn new process</a>
<a href="#syscall_list_procs">List processes</a>
<a href="#syscall_datetime">Datetime services</a>
<a href="#syscall_reboot">Reboot system</a>
<a href="#syscall_terminate">Terminate process</a>
...
System Call Aliases. When using a system call, use the alias instead of call number.
