...
loop1:
  ...
  mov d, string2
  call _puts
  mov d, $FFC8        ; 1000      a3 = 1
  mov al, $03         ; 0000_0011   restore, rate = 30ms
  mov [d], al
...
str_ok: .db $0A, $0D, "OK", $0A, $0D, 0
input_data: .fill 64, 0
string_nl: .db $0A, $0D, 0
string_loop: .db $0A, $0D, "Waiting...", 0
string_done: .db $0A, $0D, $0A, $0D, "Done Waiting...", 0
string: .db "Setting output port.", $0A, $0D, 0
string2: .db $0A, $0D, "Sending restore command,,.", $0A, $0D, 0
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
