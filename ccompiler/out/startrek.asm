...
__s71: .db "Engineering reports:\n  Insufficient energy available for maneuvering at warp %s!\n\n", 0
__s72: .db "Deflector Control Room acknowledges:\n  %d units of energy presently deployed to shields.\n", 0
__s73: .db "LT. Uhura reports:\n Message from Starfleet Command:\n\n Permission to attempt crossing of galactic perimeter\n is hereby *denied*. Shut down your engines.\n\n Chief Engineer Scott reports:\n Warp Engines shut down at sector %d, %d of quadrant %d, %d.\n\n", 0
__s74: .db "Warp Engines shut down at sector %d, %d due to bad navigation.\n\n", 0
__s75: .db "Shield Control supplies energy to complete maneuver.\n", 0
__s76: .db "YELLOW", 0
__s77: .db "*RED*", 0
__s78: .db "DOCKED", 0
__s79: .db "Shields dropped for docking purposes.", 0
__s80: .db "\n*** Short Range Sensors are out ***", 0
__s81: .db "    Stardate            %d\n", 0
__s82: .db "    Condition           %s\n", 0
__s83: .db "    Quadrant            %d, %d\n", 0
__s84: .db "    Sector              %d, %d\n", 0
__s85: .db "    Photon Torpedoes    %d\n", 0
__s86: .db "    Total Energy        %d\n", 0
__s87: .db "    Shields             %d\n", 0
__s88: .db "    Klingons Remaining  %d\n", 0
__s89: .db "Long Range Scan for Quadrant %d, %d\n\n", 0
__s90: .db "%s:", 0
__s91: .db "***", 0
__s92: .db " :", 0
__s93: .db "%s\n", 0
__s94: .db "Science Officer Spock reports:\n  'Sensors show no enemy ships in this quadrant'\n", 0
__s95: .db "Computer failure hampers accuracy.", 0
__s96: .db "Phasers locked on target;\n Energy available = %d units\n\n Number of units to fire: ", 0
__s97: .db "Not enough energy available.\n", 0
__s98: .db "Sensors show no damage to enemy at %d, %d\n\n", 0
__s99: .db "%d unit hit on Klingon at sector %d, %d\n", 0
__s100: .db "*** Klingon Destroyed ***\n", 0
__s101: .db "   (Sensors show %d units remaining.)\n\n", 0
__s102: .db "All photon torpedoes expended", 0
__s103: .db "Ensign Chekov%s", 0
__s104: .db "Torpedo Track:", 0
__s105: .db "    %d, %d\n", 0
__s106: .db "Torpedo Missed\n", 0
__s107: .db "Star at %d, %d absorbed torpedo energy.\n\n", 0
__s108: .db "*** Starbase Destroyed ***", 0
__s109: .db "That does it, Captain!!", 0
__s110: .db "You are hereby relieved of command\n", 0
__s111: .db "and sentenced to 99 stardates of hard", 0
__s112: .db "labor on Cygnus 12!!\n", 0
__s113: .db "Starfleet Command reviewing your record to consider\n court martial!\n", 0
__s114: .db "Damage Control report not available.", 0
__s115: .db "\nTechnicians standing by to effect repairs to your ship;\nEstimated time to repair: %s stardates.\n Will you authorize the repair order (y/N)? ", 0
__s116: .db "Device            State of Repair", 0
__s117: .db "%-25s%6s\n", 0
__s118: .db "\n", 0
__s119: .db "Energy available = %d\n\n Input number of units to shields: ", 0
__s120: .db "<Shields Unchanged>\n", 0
__s121: .db "Shield Control Reports:\n  'This is not the Federation Treasury.'", 0
__s122: .db "Deflector Control Room report:\n  'Shields now at %d units per your command.'\n\n", 0
__s123: .db "Computer active and awating command: ", 0
__s124: .db "Functions available from Library-Computer:\n\n", 0
__s125: .db "   0 = Cumulative Galactic Record\n", 0
__s126: .db "   1 = Status Report\n", 0
__s127: .db "   2 = Photon Torpedo Data\n", 0
__s128: .db "   3 = Starbase Nav Data\n", 0
__s129: .db "   4 = Direction/Distance Calculator\n", 0
__s130: .db "   5 = Galaxy 'Region Name' Map\n", 0
__s131: .db "\n     Computer Record of Galaxy for Quadrant %d,%d\n\n", 0
__s132: .db "     1     2     3     4     5     6     7     8", 0
__s133: .db "%s%d", 0
__s134: .db "   Status Report:\n", 0
__s135: .db "Klingon%s Left: %d\n Mission must be completed in %d.%d stardates\n", 0
__s136: .db "Your stupidity has left you on your own in the galaxy\n -- you have no starbases left!\n", 0
__s137: .db "The Federation is maintaining %d starbase%s in the galaxy\n\n", 0
__s138: .db "From Enterprise to Klingon battlecriuser%s:\n\n", 0
__s139: .db "Mr. Spock reports,\n  'Sensors show no starbases in this quadrant.'\n", 0
__s140: .db "Direction/Distance Calculator\n You are at quadrant %d,%d sector %d,%d\n\n Please enter initial X coordinate: ", 0
__s141: .db "Please enter initial Y coordinate: ", 0
__s142: .db "Please enter final X coordinate: ", 0
__s143: .db "Please enter final Y coordinate: ", 0
__s144: .db "\n                   The Galaxy\n\n", 0
__s145: .db "    1     2     3     4     5     6     7     8\n", 0
__s146: .db "%s%d ", 0
__s147: .db "  DIRECTION = ", 0
__s148: .db "%s", 0
__s149: .db "The Enterprise has been destroyed. The Federation will be conquered.\n", 0
__s150: .db "It is stardate %d.\n\n", 0
__s151: .db "There were %d Klingon Battlecruisers left at the end of your mission.\n\n", 0
__s152: .db "Congratulations, Captain!  The last Klingon Battle Cruiser\n menacing the Federation has been destoyed.\n", 0
__s153: .db "Your efficiency rating is %s\n", 0
__s154: .db "The Federation is in need of a new starship commander", 0
__s155: .db " for a similar mission.\n", 0
__s156: .db "If there is a volunteer, let him step forward and", 0
__s157: .db " enter 'aye': ", 0
__s158: .db "aye", 0
__s159: .db "Starbase shields protect the Enterprise\n", 0
__s160: .db "%d unit hit on Enterprise from sector %d, %d\n", 0
__s161: .db "    <Shields down to %d units>\n\n", 0
__s162: .db "Damage Control reports\n'%s' damaged by hit\n\n", 0
__s163: .db "    %s repair completed\n\n", 0
__s164: .db "    %s damaged\n\n", 0
__s165: .db "    %s state of repair improved\n\n", 0
__s166: .db " I", 0
__s167: .db " II", 0
__s168: .db " III", 0
__s169: .db " IV", 0
