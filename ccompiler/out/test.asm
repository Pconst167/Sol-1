...
;; puts(va.current_arg); 
  ...
  call puts
  add sp, 2
;; vap->current_arg = "My name is Paulo."; 
  lea d, [bp + -3] ; $vap
  mov d, [d]
  add d, 0
  clb
  push d
  mov b, __s1 ; "My name is Paulo."
  pop d
  mov [d], b
;; puts(vap->current_arg); 
  lea d, [bp + -3] ; $vap
  mov d, [d]
  add d, 0
  clb
...
; --- BEGIN DATA BLOCK
__s0: .db "Hello World", 0
__s1: .db "My name is Paulo.", 0
