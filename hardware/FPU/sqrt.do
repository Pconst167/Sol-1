...
add wave -noupdate -radix decimal /fpu_tb/fpu_top/a_exp_no_bias
add wave -noupdate -radix decimal /fpu_tb/fpu_top/b_exp_no_bias
...
WaveRestoreCursors {{Cursor 3} {194005 ns} 0}
...
update
WaveRestoreZoom {0 ns} {206325 ns}
